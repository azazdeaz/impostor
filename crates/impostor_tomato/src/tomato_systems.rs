...
pub struct TomatoPlugin;

impl Plugin for TomatoPlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(GrowSteps::from_steps(80))
            .add_plugin(ResourceInspectorPlugin::<GrowSteps>::default())
            .insert_resource(PlantConfig::default())
            .add_plugin(ResourceInspectorPlugin::<PlantConfig>::default())
            .insert_resource(StemMeshConfig::default())
            .add_plugin(ResourceInspectorPlugin::<StemMeshConfig>::default())
...
fn build_skeleton(
    ...
    fn add_section(
        ...
        let base = commands
            ...
            // .insert(CollisionGroups::new(0b0000.into(), 0b0000.into()))
    ...
    for seed in seeds.iter() {
        ...
        let root_entity = commands
            .spawn(RigidBody::Fixed)
            .insert(TransformBundle::from_transform(root_transform))
            .id();
        add_section(
            &mut commands,
            seed,
