...
def test_grow(iterations=120):
    ...
    branch_system = syst.BranchingSystem(internode_spacing=NormalDistribution(0.6, 0.1), max_branch_order=1)
    ...
    start_leaf_system = syst.StartLeafSystem(at_stem_length=NormalDistribution(0.5, 0.1), branch_order=1)
