...
class ScaffoldingSolver(BasePart, rr.AsComponents):
    ...
    def step(self, plant: Plant, _entity: Entity):
        ...
        for root in roots:
            locked_position_indices += self._layers[root].get_indices(root)
        ...
        rr.log(
            ...
            rr.Points3D(self._current_positions.numpy(), radii=0.005),
        )
        ...
        rr.log(
            ...
            rr.Points3D(
                ideal_positions.numpy(), radii=0.004, colors=(0.2, 0.8, 0.2, 0.7)
            ),
        )
